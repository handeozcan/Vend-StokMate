...
// Port: yerel geliştirmede sabit 5080 (tüm arayüzler — emülatör/fiziksel cihaz makinenin
// IP'siyle bağlanabilir). Deployment ortamında (Render vb.) ASPNETCORE_URLS ortam
// değişkeni varsa o kullanılır; UseUrls env'i ezer, bu yüzden burada koşullu seçilir.
builder.WebHost.UseUrls(
    Environment.GetEnvironmentVariable("ASPNETCORE_URLS") ?? "http://0.0.0.0:5080");
